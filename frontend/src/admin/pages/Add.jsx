...
const Add = () => {
  ...
  const availableColors = [
    { name: "Red", value: "red", class: "bg-red-700" },
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='flex gap-3 flex-wrap'>
          {availableColors.map((color) => (
            <div
              ...
              className={`w-8 h-8 rounded-full cursor-pointer flex items-center justify-center ${color.class} ${colors.includes(color.value) ? "ring-2 ring-black ring-offset-2" : ""}`}
              title={color.name}
            >
              {color.value === "white"}
            </div>
      ...
      <button className='w-50 py-3 mt-4 bg-black text-white cursor-pointer' type='submit'>ADD PRODUCT</button>
