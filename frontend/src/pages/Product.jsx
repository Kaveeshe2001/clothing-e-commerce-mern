    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
        ...
        <div className="flex-1">
            ...
            <div className="flex gap-2">
              {productData.colors.map((item, index) => (
                <button
                  ...
                  className={`w-8 h-8 rounded-full border ${item === color ? 'ring-2 ring-black ring-offset-2' : ''}`} 
          ...
          <button onClick={() => addToCart(productData._id, size, color)} className="bg-black text-white px-8 py-3 text-sm cursor-pointer active:bg-gray-700">ADD TO CART</button>
